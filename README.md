...
- Basic URL scheme: CleanShot 3.5.1+
- Advanced parameters: CleanShot 4.7+
- Settings tab parameter: CleanShot 4.7+
- History management: CleanShot 4.4+
...
## CleanShot Version Compatibility

This MCP server supports all CleanShot URL scheme features across different versions:

- **CleanShot 3.5.1+**: Basic URL scheme support
- **CleanShot 3.8.1+**: Text recognition, annotation tools
- **CleanShot 4.2+**: All-In-One mode  
- **CleanShot 4.4+**: History management
- **CleanShot 4.7+**: Advanced positioning parameters, settings tabs
